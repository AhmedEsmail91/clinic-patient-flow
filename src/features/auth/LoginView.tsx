...
const LoginView: React.FC = () => {
  const { isAuthenticated, isLoading: mainLoading } = useAuth();
  ...
  const from = searchParams.get("from") || "/appointment";
  if (isAuthenticated) {
    return <div />;
  }
        ...
        >
          ...
          <Card className="medical-card">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-bold text-primary">{t("auth.login.title")}</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="button" variant="outline" onClick={handleGoogleLogin} className="w-full border-2 hover:bg-accent">
                ...
                <div className="text-center">
                  ...
                  <Link href="/register" className="text-primary hover:text-primary-dark smooth-transition font-medium">
